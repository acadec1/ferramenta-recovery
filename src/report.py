"""Relatorios periciais em PDF (ReportLab).

Dois relatorios, com finalidades diferentes: ``generate_report`` exporta a
cadeia de custodia completa (todos os eventos registados) e
``generate_operation_report`` documenta uma unica operacao de recuperacao, com
a identificacao, os totais e a lista de ficheiros processados.
"""
...
# ---------------------------------------------------------------------------
# Relatorio de uma operacao de recuperacao
# ---------------------------------------------------------------------------
